...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public Adapter(Context mContext, ArrayList<NewsModelClass> modelClassArrayList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.layout_news_item,null,false);
