...
public class CardAdapter extends RecyclerView.Adapter<CardAdapter.ViewHolder> {
    ...
    int m = 1;
    Context mContext;
    List<com.example.covid19.ModelClass> countryList;

    public CardAdapter(Context mContext, List<com.example.covid19.ModelClass> countryList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        com.example.covid19.ModelClass modelClass = countryList.get(position);
